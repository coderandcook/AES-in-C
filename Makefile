...
LIB_SRC=poly.c div_poly.c div_generic.c mod3.c SubBytes2.c ShiftRows2.c MixColumns.c AddRoundKey3.c KeyExpansion.c cipher.c InvShiftRows.c InvSubBytes.c InvMixColumns.c
TEST_SRC=aes_test.c
